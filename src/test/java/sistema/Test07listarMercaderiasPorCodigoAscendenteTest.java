...
public class Test07listarMercaderiasPorCodigoAscendenteTest {
    ...
    void listarMercaderiasPorCodigoAscendenteOkVarias() {
        ...
        s.registrarMercaderia("99999", "ZZ-999-ZZZ", "Mercaderia Z", false, Categoria.OTROS);
        s.registrarMercaderia("11111", "AA-111-AAA", "Mercaderia A", true, Categoria.TEXTIL);
        s.registrarMercaderia("55555", "MM-555-MMM", "Mercaderia M", false, Categoria.OTROS);
        ...
        String esperado = "11111;AA-111-AAA;Mercaderia A;true;TEXTIL|" +
                "55555;MM-555-MMM;Mercaderia M;false;OTROS|" +
                "99999;ZZ-999-ZZZ;Mercaderia Z;false;OTROS";
    ...
    void listarMercaderiasPorCodigoAscendenteLimiteCapacidad() {
        ...
        s.registrarMercaderia("3", "CC-333", "M3", false, Categoria.OTROS);
        s.registrarMercaderia("1", "AA-111", "M1", false, Categoria.OTROS);
        s.registrarMercaderia("2", "BB-222", "M2", true, Categoria.OTROS);

        retorno = s.listarMercaderiasPorCodigoAscendente();

        assertEquals(Retorno.Resultado.OK, retorno.getResultado());

        String esperado = "1;AA-111;M1;false;OTROS|" +
                "2;BB-222;M2;true;OTROS|" +
                "3;CC-333;M3;false;OTROS";
